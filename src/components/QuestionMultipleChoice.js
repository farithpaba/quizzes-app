...
export default function QuestionMultipleChoice(props) {
    ...
    return (
        <div ref={setNodeRef} style={style} className=" bg-white max-w-5xl mx-auto py-2  rounded-lg shadow-xl my-3 ">
            ...
            {modalEdit  && <ModalEditMultipleChoice obj={props.obj} onClose={CloseModalMultipleChoice} handleValue={handleObj} />}
        </div>
    )
}
