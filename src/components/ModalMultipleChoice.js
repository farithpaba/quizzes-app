...
export default function ModalMultipleChoice(props) {
                ...
                <div className='w-[90%] lg:w-[60%]  bg-white h-auto pb-5  rounded-3xl  border'>
                    ...
                    <label className="flex w-full relative px-3 mt-4">
                        <input
                            id='pregunta'
                            type="text"
                            defaultValue={question.pregunta}
                    ...
                    <div className='px-5'>
                        ...
                        <div className="flex flex-col gap-2 pb-3">
                            ...
                            {question.respuestas.map((obj) =>
                                <button onClick={() => setRespuestaCorrecta(obj)} className="border boderColorCustom focus:bgColorCustom focus:text-white textColorCustom py-2 px-4 hover:bgColorCustom hover:text-white rounded-xl transition-colors text-center  w-1/2 mx-auto">
                                    {obj}
                                </button>
                            )}
