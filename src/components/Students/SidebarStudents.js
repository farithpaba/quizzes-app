            ...
            >
                ...
                <div>
                    ...
                    <nav>
                        <a
                            onClick={()=>navigate("/")}
                            className={`${(location.pathname === "/" || location.pathname === "/module") ? "flex items-center   font-semibold gap-4 bgColorCustom p-4 text-white rounded-lg hover:cursor-pointer" : "flex items-center hover:cursor-pointer text-gray-400 font-semibold gap-4 hover:bg-purple-600 p-4 hover:text-white rounded-lg transition-colors"}`}
                        >
