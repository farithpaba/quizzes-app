...
export default function ModalCreate(props) {
    ...
    const [btnFechaLimite, setBtnFechaLimite] = useState(false)
    const [btnCronometro, setBtnCronometro] = useState(false)
    const [numIntentos, setNumIntentos] = useState(1);
    const [btnCalificable, setBtnCalificable] = useState(false);
                ...
                <div className='w-[90%] lg:w-[60%] bg-white h-auto pb-5 rounded-3xl  border'>
                    ...
                    <div className='px-3 '>
                        ...
                        <div className='flex items-center gap-2 ml-2 my-2'>
                            ...
                            <input onClick={() => setBtnCronometro(!btnCronometro)} id='cronometro' type='checkbox' />
                        </div>
                        {btnCronometro &&
                            <div className='flex items-center gap-2 ml-2'>
                        ...
                        <div className='flex items-center gap-2 ml-2 my-2'>
                            ...
                            <input onClick={() => setBtnFechaLimite(!btnFechaLimite)} id='fechasLimite' type='checkbox' />
                        </div>
                        ...
                        {btnFechaLimite &&
                            <>
                                <div className='flex items-center gap-2 ml-2 my-2'>
                                    ...
                                    <input id='fechaInicio' className='border outline-none focus:boderColorCustom px-2 py-1 rounded-full text-gray-500' type='date' />
                                </div>

                                <div className='flex items-center gap-2 ml-2 my-2'>
                                    <p className='text-gray-500'>Fecha de Cierre:</p>
                                    <input id='fechaCierre' className='border outline-none focus:boderColorCustom px-2 py-1 rounded-full text-gray-500' type='date' />
                                </div>
                            </>
                        }
                        {/* Intentos permitidos */}
                        ...
                        {/* Calificable */}
                        <div className='flex items-center gap-2 ml-2 my-2'>
                            <p className='text-gray-500'>Auto-calificación:</p>
                            <input onClick={() => setBtnCalificable(!btnCalificable)} id='calificable' type='checkbox' />
                        </div>
                        {/* Revision */}
                        {btnCalificable &&
                            <div className='flex items-center gap-2 ml-2 my-2'>
